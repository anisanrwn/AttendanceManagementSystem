...
715	3	nirwanaanisa1508@gmail.com	127.0.0.1	2025-05-23 16:16:10.852762	f	Edge 136.0.0	2	\N
\.
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 715, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 167, true);
...
SELECT pg_catalog.setval('public.permissions_permissions_id_seq', 20, true);
