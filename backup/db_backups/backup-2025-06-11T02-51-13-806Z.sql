...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 344, true);
...
SELECT pg_catalog.setval('public.lock_system_lock_id_seq', 30, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 983, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 196, true);
