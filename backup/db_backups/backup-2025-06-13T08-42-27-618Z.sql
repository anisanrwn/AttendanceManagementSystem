...
194	21	Login dari Perangkat Baru	Login terdeteksi dari IP: 127.0.0.1, Perangkat: Chrome Mobile 134.0.0	new_device	f	2025-06-10 18:10:20.308135	\N
195	21	Login dari Perangkat Baru	Login terdeteksi dari IP: 127.0.0.1, Perangkat: Opera 119.0.0	new_device	f	2025-06-10 18:18:04.628219	\N
...
1	1	nblaalb	nabilalb2004@gmail.com	$2b$12$JnBtsYTTsnhcD5tkNlT1Geo.vttLhfjPMY.Cw5IKyRxHE3bsDFDRG
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 360, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.lock_system_lock_id_seq', 32, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1011, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 198, true);
