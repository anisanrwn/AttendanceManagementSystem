...
108	7	Login dari Perangkat Baru	Login terdeteksi dari IP: 127.0.0.1, Perangkat: Chrome 136.0.0	new_device	f	2025-05-23 10:31:26.56799	\N
...
125	7	Login dari Perangkat Baru	Login terdeteksi dari IP: 127.0.0.1, Perangkat: Edge 136.0.0	new_device	f	2025-05-23 06:30:39.603716	\N
...
132	7	Login dari Perangkat Baru	Login terdeteksi dari IP: 127.0.0.1, Perangkat: Chrome 136.0.0	new_device	f	2025-05-23 06:38:29.16872	\N
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 668, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 140, true);
...
SELECT pg_catalog.setval('public.permissions_permissions_id_seq', 16, true);
