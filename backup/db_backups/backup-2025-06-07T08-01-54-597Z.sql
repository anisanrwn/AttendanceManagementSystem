...
191	21	Login dari Perangkat Baru	Login terdeteksi dari IP: 127.0.0.1, Perangkat: Opera 119.0.0	new_device	f	2025-05-28 10:24:15.973511	\N
\.
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 303, true);
...
SELECT pg_catalog.setval('public.lock_system_lock_id_seq', 22, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 898, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 191, true);
