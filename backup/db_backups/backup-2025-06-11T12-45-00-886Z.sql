...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 353, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 995, true);
